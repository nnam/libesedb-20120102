...
libfmapi_lcid_language_tag_t libfmapi_lcid_language_tags[ ] = {
	{ 0x0001, "ar",			"Arabic" },
	{ 0x0002, "bg",			"Bulgarian" },
	{ 0x0003, "ca",			"Catalan" },
             ...
             uint16_t lcid_language_tag )
{
	...
	while( ( libfmapi_lcid_language_tags[ iterator ] ).lcid_language_tag != (uint16_t) -1 )
	{
		if( ( libfmapi_lcid_language_tags[ iterator ] ).lcid_language_tag == lcid_language_tag )
		{
			break;
		}
		iterator++;
	...
	return(
	 ( libfmapi_lcid_language_tags[ iterator ] ).identifier );
}
             ...
             uint16_t lcid_language_tag )
{
	...
	return(
	 ( libfmapi_lcid_language_tags[ iterator ] ).description );
}
