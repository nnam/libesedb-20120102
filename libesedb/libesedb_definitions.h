...
/* Definitions of item flags
 */
enum LIBESEDB_ITEM_FLAGS
{
	LIBESEDB_ITEM_FLAG_NON_MANAGED_FILE_IO_HANDLE			= 0x00,
	LIBESEDB_ITEM_FLAG_MANAGED_FILE_IO_HANDLE			= 0x01
};

#if defined( HAVE_DEBUG_OUTPUT )
#define LIBESEDB_ITEM_FLAGS_DEFAULT					LIBESEDB_ITEM_FLAG_MANAGED_FILE_IO_HANDLE
#else
#define LIBESEDB_ITEM_FLAGS_DEFAULT					LIBESEDB_ITEM_FLAG_NON_MANAGED_FILE_IO_HANDLE
#endif
